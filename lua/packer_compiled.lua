...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'nvim-lsp-installer', 'nvim-cmp', 'gitsigns.nvim', 'Comment.nvim', 'nvim-lspconfig', 'neoscroll.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'FixCursorHold.nvim', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
