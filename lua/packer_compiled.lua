...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'FixCursorHold.nvim', 'lspsaga.nvim', 'nvim-lsp-installer', 'neoscroll.nvim', 'null-ls.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'nvim-cmp', 'nvim-lspconfig', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
