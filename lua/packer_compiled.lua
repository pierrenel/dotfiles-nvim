...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'lspsaga.nvim', 'FixCursorHold.nvim', 'nvim-lsp-installer', 'neoscroll.nvim', 'null-ls.nvim', 'nvim-cmp', 'gitsigns.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
