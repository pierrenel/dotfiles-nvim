...
_G.packer_plugins = {
  ...
  srcery = {
    loaded = true,
    path = "/Users/pierre/.local/share/nvim/site/pack/packer/start/srcery",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-lspconfig', 'nvim-colorizer.lua', 'neoscroll.nvim', 'null-ls.nvim', 'FixCursorHold.nvim', 'Comment.nvim', 'nvim-lsp-installer', 'lspsaga.nvim', 'nvim-cmp', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
